...
import nextflow.fovus.FovusFileCopyStrategy
...
class S3PathFactory extends FileSystemPathFactory {
    ...
    protected String toUriString(Path path) {
        return path instanceof FovusS3Path ? "fovus:/$path".toString() : null
    }
    ...
    /**
     * Creates a {@link FovusS3Path} from a S3 formatted URI.
     *
     * @param path
