...
import nextflow.fovus.nio.util.ByteBufferInputStream;
...
public final class FovusS3OutputStream extends OutputStream {
     ...
     */
    private final FovusClient fovusClient;
...
//    private final S3ObjectId objectId;
     ...
     *
     */
    public FovusS3OutputStream(final FovusClient fovusClient, Path fovuS3Path, S3MultipartOptions request) {
        this.fovusClient = requireNonNull(fovusClient);
...
//    }
    ...
    public void close() throws IOException {
        ...
        try (FileOutputStream out = new FileOutputStream(tempFile, true)) {
            ...
            String jobId = ((FovusS3Path) fovuS3Path).getFileJobId(); // If available; null otherwise

            // Run CLI upload
            fovusClient.uploadJobFile(filePath, basePath, jobId);
