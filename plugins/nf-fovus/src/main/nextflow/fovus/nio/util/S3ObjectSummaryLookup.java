...
public class S3ObjectSummaryLookup {
     ...
     */
    public S3ObjectSummary lookup(FovusPath s3Path) throws NoSuchFileException {
        ...
        final FovusJobClient client = s3Path.getFileSystem().getClient();
        /*
    ...
    private boolean matchName(FovusPath s3Path, ObjectMetaData objectMetaData) {
...
//        FovusJobClient client = s3Path.getFileSystem().getClient();
//        try {
